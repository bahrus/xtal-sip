...
If this is a concern, the expansion could be done by the service worker instead of by xtal-sip, with no sacrifice to the bandwidth footprint (and likely gaining back the performance degration discussed in the previous paragraph).
